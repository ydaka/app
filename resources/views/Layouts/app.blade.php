            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <ul class="nav">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{route('asesor.index')}}">
                                    Asesores
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link active" href="{{route('producto.index')}}">
                                    Productos
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link active" href="{{route('local.index')}}">
                                    Locales
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link active" href="{{route('proveedor.index')}}">
                                    Proveedores
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link active" href="{{route('movimiento.index')}}">
                                    Movimientos
                                </a>
                            </li>
